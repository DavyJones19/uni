...
import { ConductoresFormModal } from "../conductores/ConductoresFormModal";
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[300px]">
          <DialogHeader>
            <DialogTitle className="text-base">Eliminar Conductor</DialogTitle>
          </DialogHeader>
          <div className="py-2">
            <p className="text-sm text-muted-foreground">
              ¿Estás seguro de que deseas eliminar el conductor con ID{" "}
...
export default function RolesPage() {
  ...
  const columns = useMemo<ColumnDef<RowData>[]>(
    () => [
      { id: "CONDUCTOR", header: "Conductor", priority: 1 },
  ...
  const handleExportExcel = useCallback(() => {
    ...
    const fileName = "conductores.xlsx";
    ...
    <div className="mx-auto w-full max-w-[96rem] px-4 py-8 flex flex-col gap-6 bg-white min-h-screen">
      <header className="space-y-2 border-b pb-4">
        ...
        <p className="text-sm text-zinc-500">
          Módulo de administración de conductores
        </p>
      </header>
